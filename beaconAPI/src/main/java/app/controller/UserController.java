...
public class UserController {
	...
	public Map<String, Object> createUser(@RequestBody Map<String, Object> userMap){
		...
		User user = new User(userMap.get("user").toString(), userMap.get("password").toString(),(Boolean)userMap.get("enable") ,Integer.parseInt(userMap.get("category_id").toString()),Integer.parseInt(userMap.get("total_gift_points").toString()),userMap.get("creationDate").toString(),userMap.get("modifiedDate").toString());
