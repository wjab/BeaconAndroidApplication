...
class BaseViewController: UIViewController, SlideMenuDelegate {
    ...
    func slideMenuItemSelectedAtIndex(index: Int32) {
        ...
        case 2:
            ...
            break
        case 3:
            self.openViewControllerBasedOnIdentifier("WishViewController")
            break
        case 4:
            self.openViewControllerBasedOnIdentifier("HomeVC")
            break
        case 5:
            self.openViewControllerBasedOnIdentifier("PointsTabViewController")
            break
        case 6:
            self.openViewControllerBasedOnIdentifier("FAQTabViewController")
            break
        case 7:
            self.openViewControllerBasedOnIdentifier("NotificationTabViewController")
            break
        default:
            print("default\n", terminator: "")
        }
