...
public class TabPerfilFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context=getActivity();
        View rootView= inflater.inflate(R.layout.fragment_tab_perfil, container, false);
        listView= (ListView)rootView.findViewById(R.id.listviewFaq);
        service();
        return rootView;
    }
